...
class TravelAgent:
    ...
    def set_trip_one_city_round_way(self,start, end, start_date):
        trip1 = self.set_trip_multi_city_one_way(start, end,start_date)
        trip2 = self.set_trip_multi_city_one_way(end, start,start_date)
        return [trip1, trip2]
        """
            trip_info: [city0, city1, city2]
    ...
    def set_trip_two_city_one_way(self,trip_info, start_date):
        trip1 = self.set_trip_multi_city_one_way(trip_info[0], trip_info[1],start_date)
        trip2 = self.set_trip_multi_city_one_way(trip_info[1], trip_info[2],start_date)
        return [trip1, trip2]
